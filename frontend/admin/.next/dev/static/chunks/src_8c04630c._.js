...
"[project]/src/components/AdminAuthProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminAuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminAuthProvider.useEffect": ()=>{
            ...
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AdminAuthProvider.useEffect": (event, session)=>{
                    if (event === 'SIGNED_OUT') {
                        router.push('/login');
    ...
    const verifyAdminRole = async (userId)=>{
        ...
        try {
            ...
            const { data: userData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('auth_user_id', userId).single();
            if (error || !userData) {
                // Try profiles table as fallback
                const { data: profileData, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', userId).single();
...
_s(AdminAuthProvider, "MtVCuTretTa37YolIkpApzwezCU=", false, function() {
    return [
...
//# sourceMappingURL=src_8c04630c._.js.map